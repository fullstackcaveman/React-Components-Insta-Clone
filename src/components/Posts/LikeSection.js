...
const LikeSection = (props) => {
	...
	const onHeartClick = () => {
		// likePost();
		setLikedPost(likedPost ? false : true);
		likedPost ? unLikePost() : likePost();
	};
		...
		<div>
			<div className='like-section' key='likes-icons-container'>
				<div className='like-section-wrapper'>
					{likedPost ? (
						<FontAwesomeIcon icon={solidHeart} onClick={onHeartClick} />
					) : (
						<FontAwesomeIcon icon={faHeart} onClick={onHeartClick} />
					)}
				</div>
				<div className='like-section-wrapper'>
